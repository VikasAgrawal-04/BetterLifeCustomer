...
CreateAppointmentParams _$CreateAppointmentParamsFromJson(
    ...
    CreateAppointmentParams(
      ...
      taxiNeeded: const BoolConverter().fromJson(json['taxiNeeded'] as int),
      acTaxi: const BoolConverter().fromJson(json['acTaxi'] as int),
      drivetaxi: const BoolConverter().fromJson(json['drivetaxi'] as int),
