...
//
//     final locationPredictionModel = locationPredictionModelFromJson(jsonString);

import 'dart:convert';

LocationPredictionModel locationPredictionModelFromJson(String str) =>
    LocationPredictionModel.fromJson(json.decode(str));

String locationPredictionModelToJson(LocationPredictionModel data) =>
...
class Prediction {
  ...
  factory Prediction.fromJson(Map<String, dynamic> json) => Prediction(
        ...
        distance: json['distance_meters'] ?? 0,
